...
namespace QuanLyCoffee.Models
{
    class Connection
    {
        //Data Source=DSNGUYEN-PC\SQLEXPRESS;Initial Catalog=CoffeeManagement;Integrated Security=True
        public static string sqlcon = @"Data Source=DSNGUYEN-PC\SQLEXPRESS;Initial Catalog=CoffeeManagement;Integrated Security=True";
        //public static string sqlcon = @"server=DSNGUYEN-PC\SQLEXPRESS; uid=DSNGUYEN-PC\Nguyen; pwd=; database=CoffeeManagement";
